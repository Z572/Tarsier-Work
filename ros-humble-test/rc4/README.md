...
qemu 8.0.2
cmd: qemu-system-aarch64 -m 4096 -cpu cortex-a72 -smp 8 -M virt -bios qemu-uefi-aarch64.bin openEuler-22.03-LTS-SP2-aarch64.qcow2 -net user,hostfwd=tcp::10022-:22 -net nic
