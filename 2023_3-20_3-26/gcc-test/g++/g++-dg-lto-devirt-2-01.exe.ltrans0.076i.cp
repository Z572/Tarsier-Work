...
;; Function foo (_ZN1A3fooEi, funcdef_no=2, decl_uid=1393, cgraph_uid=1, symbol_order=1)
...
;; Function foo (_ZN1B3fooEi, funcdef_no=3, decl_uid=1397, cgraph_uid=2, symbol_order=2)
...
;; Function get_input (_Z9get_inputv, funcdef_no=4, decl_uid=1398, cgraph_uid=3, symbol_order=4)
...
;; Function middleman.constprop (_ZN1A9middlemanEi.constprop.0, funcdef_no=1, decl_uid=1406, cgraph_uid=9, symbol_order=32)

Modification phase of node middleman.constprop/32
Adjusting mask for param 0 to 0xfffffffffffffff8
Adjusting align: 8, misalign: 0
Setting nonnull for 0
middleman.constprop (struct A * const this, int i)
{
  ...
  _2 = this_1(D)->_vptr.A;
  _3 = *_2;
  _5 = OBJ_TYPE_REF(_3;(struct A)this_1(D)->0) (this_1(D), i_4(D));
  return _5;
